...
class _CouncilSetupScreenState extends State<CouncilSetupScreen> {
  ...
  bool get _canProceed {
    switch (_currentStep) {
      ...
      case 1: return _agents.length >= 2;
      case 2: return true;
      case 3: return true;
            ...
            child: PageView(
              ...
              children: [
                ...
                _SettingsStep(
                  ...
                  onThresholdChanged: (v) => setState(() => _consensusThreshold = v),
                ),
                _ReviewStep(
      ...
      child: Row(
        children: [
          ...
          if (_currentStep < _steps.length - 1)
            ...
            NeonButton(
              label: widget.existingCouncil != null ? 'Update Council' : 'Create Council',
              icon: Icons.check,
...
class _AgentsStep extends StatelessWidget {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    ProviderBadge(provider: agent.provider.name, showLabel: false),
          ...
          Row(
            children: [
              IconButton(
                ...
                onPressed: () => _showAgentDialog(context, agent: agent, index: index),
              ),
              IconButton(
  ...
  void _showAgentDialog(BuildContext context, {AgentConfig? agent, int? index}) async {
...
class _AddAgentDialogState extends State<_AddAgentDialog> {
  ...
  Future<void> _fetchModels(ProviderType provider) async {
    ...
    try {
      final models = await _api.getProviderModels(provider.name);
      if (mounted) {
        setState(() {
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        NeonButton(
          ...
          onPressed: _selectedProvider != null && _nameController.text.isNotEmpty
              ? () {
                  Navigator.pop(
                    context,
                    AgentConfig(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text('50%', style: TextStyle(color: CyberColors.textMuted, fontSize: 12)),
                    Text('100%', style: TextStyle(color: CyberColors.textMuted, fontSize: 12)),
                  ],
                ),
              ],
            ),
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Center(
                          child: Text(agent.role.icon, style: const TextStyle(fontSize: 16)),
                        ),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
